...
!
  ...
  real,save :: acceptance=0.75 ! DEFAULT 0.65 NO MODIFICAR MUCHO. (0.5-0.8) 
  real :: xbeta=10.0000 !2
  real :: goener=0.50 !*8.314!     0.50
  real :: sigmago=0.1500
  real *8 :: dtol=0.50000
  real :: wellWidth=0.200            ! DEFAULT 0.13
 ...
 INTEGER :: Ener_evo_size=10         ! DEFAULT 15
 INTEGER , PARAMETER :: NEVECS=5
 real*8 :: hstep=1.0
 REAL , PARAMETER :: DEGO_BASE=0.020 ! 5 porciento del pozo a sacar en cada metaDMD
